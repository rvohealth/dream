import { CalendarDate, DreamSerializer, SimpleObjectSerializer } from '../../../../src/index.js'
  ...
  context('simple objects', () => {
    it('renders the associated objects using the provided serializer callback', () => {
      ...
      const MySerializer = (data: PetWithSimpleUser) =>
        SimpleObjectSerializer(data).rendersOne('user', { serializerCallback: () => UserSerializer })
  ...
  context('Dream model', () => {
    it('renders the Dream model’s default serializer', () => {
      ...
      const MySerializer = (data: PetWithDreamUser) =>
        SimpleObjectSerializer(data).rendersOne('user', { dreamClass: DreamUser })
    ...
    it('supports specifying a specific serializerKey', () => {
      ...
      const MySerializer = (data: PetWithDreamUser) =>
        SimpleObjectSerializer(data).rendersOne('user', { dreamClass: DreamUser, serializerKey: 'summary' })
    ...
    it('supports supplying a custom serializer', () => {
      ...
      const MySerializer = (data: PetWithDreamUser) =>
        SimpleObjectSerializer(data).rendersOne('user', { serializerCallback: () => CustomSerializer })
    ...
    it("supports customizing the name of the thing rendered via { as: '...' } (replaces `source: string`)", () => {
      ...
      const MySerializer = (data: PetWithDreamUser) =>
        SimpleObjectSerializer(data).rendersOne('user', { dreamClass: DreamUser, as: 'user2' })
