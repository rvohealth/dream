...
describe('ViewModelSerializer json attributes', () => {
  context('all Dream column types', () => {
    const MySerializer = (data: ModelForOpenapiTypeSpecs) =>
      ViewModelSerializer(ModelForOpenapiTypeSpecs, data)
    ...
    let serializer: ViewModelSerializerBuilder<typeof ModelForOpenapiTypeSpecs, ModelForOpenapiTypeSpecs, any>
