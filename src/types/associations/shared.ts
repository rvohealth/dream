...
> = Partial<
  MergeUnionOfRecordTypes<
    | Whereable<DB[TableName]>
    | DreamSelectable<DB, Schema, TableName>
    // TODO: refine record type
    | (AssociatedModelParam<I> extends never ? Record<string, unknown> : AssociatedModelParam<I>)
  >
>
