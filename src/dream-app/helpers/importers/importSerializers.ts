...
import { DreamSerializerBuilder, ViewModelSerializerBuilder } from '../../../serializer/index.js'
    ...
    Object.keys(allSerializers).forEach(key => {
      ...
      if (
        ...
        (potentialSerializer(undefined as any, undefined as any) instanceof DreamSerializerBuilder ||
          potentialSerializer(undefined as any, undefined as any) instanceof ViewModelSerializerBuilder)
      ) {
