...
export default class CalendarDate {
   ...
   * @internal
   */
  public constructor(source?: DateTime | CalendarDateObject | null) {
   ...
   * ```
   */
  public static today(opts?: { zone?: string | Zone }): CalendarDate {
   ...
   * ```
   */
  public set(values: Partial<CalendarDateObject>): CalendarDate {
