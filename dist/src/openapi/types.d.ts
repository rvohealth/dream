...
export type OpenapiSchemaBodyShorthand = OpenapiSchemaBase | OpenapiSchemaShorthandPrimitiveGeneric | OpenapiSchemaShorthandExpressionAnyOf | OpenapiSchemaShorthandExpressionOneOf | OpenapiSchemaShorthandExpressionAllOf | OpenapiSchemaObjectShorthand | OpenapiSchemaArrayShorthand | OpenapiSchemaExpressionRefSchemaShorthand | OpenapiSchemaShorthandExpressionSerializerRef;
export type OpenapiSchemaBase = OpenapiSchemaString | OpenapiSchemaInteger | OpenapiSchemaNumber | OpenapiSchemaExpressionRef;
...
export type OpenapiSchemaObjectBase = CommonOpenapiSchemaObjectFields<{
    ...
    additionalProperties?: OpenapiSchemaProperties | OpenapiSchemaExpressionOneOf | OpenapiSchemaExpressionAnyOf | OpenapiSchemaExpressionAllOf;
}>;
...
export type OpenapiSchemaObjectBaseShorthand = CommonOpenapiSchemaObjectFields<{
    minProperties?: number;
    maxProperties?: number;
    properties?: OpenapiSchemaPropertiesShorthand | OpenapiSchemaShorthandExpressionOneOf | OpenapiSchemaShorthandExpressionAnyOf | OpenapiSchemaShorthandExpressionAllOf | OpenapiSchemaShorthandExpressionSerializerRef;
    additionalProperties?: OpenapiSchemaPropertiesShorthand | OpenapiSchemaShorthandExpressionOneOf | OpenapiSchemaShorthandExpressionAnyOf | OpenapiSchemaShorthandExpressionAllOf | OpenapiSchemaShorthandExpressionSerializerRef;
}>;
...
export type OpenapiSchemaArrayShorthand = OpenapiSchemaCommonFields<{
    type: 'array';
    items: OpenapiSchemaBodyShorthand | OpenapiSchemaShorthandExpressionAllOf | OpenapiSchemaShorthandExpressionAnyOf | OpenapiSchemaShorthandExpressionOneOf | OpenapiSchemaShorthandExpressionSerializerRef;
}>;
...
export declare const openapiPrimitiveTypes: readonly ["string", "boolean", "number", "date", "date-time", "double", "integer"];
export declare const openapiShorthandPrimitiveTypes: readonly ["string", "boolean", "number", "date", "date-time", "double", "integer", "decimal", "string[]", "boolean[]", "number[]", "date[]", "date-time[]", "decimal[]", "double[]", "integer[]", "json"];
