...
BREAKING CHANGE: apologies that we're introducing a breaking change, but we found it necessary and worth it to support microseconds and took the opportunity to add a ClockTime class and standardize APIs between DateTime, CalendarDate, and ClockTime.
...
- Constructor of CalendarDate updated to match the pattern used for ClockTime (another BREAKING CHANGE)
