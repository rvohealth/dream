...
import {
  ...
  CatTreats,
  CatTreatsValues,
  CircularFooTypesEnum,
  CircularFooTypesEnumValues,
...
export const schema = {
  ...
  circular_foo_bases: {
    ...
    columns: {
      ...
      type: {
        coercedType: {} as CircularFooTypesEnum | null,
        enumType: {} as CircularFooTypesEnum,
        enumValues: CircularFooTypesEnumValues,
        dbType: 'circular_foo_types_enum',
        allowNull: true,
        isArray: false,
      },
      updatedAt: {
