...
export const globalSchema = {
  ...
  globalNames: {
    models: [
      'Balloon',
      'Balloon/Latex',
      'Balloon/Latex/Animal',
      'Balloon/Mylar',
      'BalloonLine',
      'BalloonSpotter',
      'BalloonSpotterBalloon',
      'Collar',
      'Composition',
      'CompositionAsset',
      ...
      'EdgeCaseAttribute',
      'ExtraRating/Base',
      'ExtraRating/HeartRating',
      'ExtraRating/StarRating',
      'Graph/Edge',
      'Graph/EdgeNode',
      'Graph/Node',
      'IncompatibleForeignKeyTypeExample',
      'LocalizedText',
      'ModelWithoutCustomDeletedAt',
      'ModelWithoutDeletedAt',
      'ModelWithoutUpdatedAt',
      'NonNullRating',
      'Pet',
      'PetUnderstudyJoinModel',
      'Post',
      'PostComment',
      'PostVisibility',
      'Rating',
