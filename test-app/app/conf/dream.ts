...
export default async function (dreamApp: DreamApp) {
  ...
  dreamApp.set('importExtension', '.js') // this is the default, but this ensures we are able to set it
  ...
  dreamApp.set('db', 'mysql', {
    ...
    primary: {
      user: AppEnv.string('MYSQL_DB_USER'),
      password: AppEnv.string('MYSQL_DB_PASSWORD', { optional: !AppEnv.isProduction }),
