...
export interface ModelForDatabaseTypeSpecs {
  createdAt: Timestamp
  id: Generated<Int8>
  myDate: Timestamp | null
  myDatetime: Timestamp | null
  myDatetimeTz: Timestamp | null
  myTimeWithZone: ClockTimeTz | null
  myTimeWithoutZone: ClockTime | null
  petId: Int8 | null
  updatedAt: Timestamp
}
...
export interface SortableCascadeLeaves {
  createdAt: Timestamp
  id: Generated<Int8>
  ownerId: Int8
  position: number | null
