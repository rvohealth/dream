...
export const BalloonColorsEnumArray = ['blue', 'green', 'red']

export type BalloonLineMaterialsEnum = 'nylon' | 'ribbon' | 'twine' | 'yarn'
export const BalloonLineMaterialsEnumArray = ['nylon', 'ribbon', 'twine', 'yarn']

export type BalloonTypesEnum = 'Animal' | 'Latex' | 'Mylar'
export const BalloonTypesEnumArray = ['Animal', 'Latex', 'Mylar']

export type CatTreats = 'cat-safe chalupas (catlupas,supaloopas)' | 'chicken' | 'ocean fish' | 'tuna'
export const CatTreatsArray = ['cat-safe chalupas (catlupas,supaloopas)', 'chicken', 'ocean fish', 'tuna']

export type ExtraRateableTypesEnum = 'Balloon' | 'Composition' | 'Post'
export const ExtraRateableTypesEnumArray = ['Balloon', 'Composition', 'Post']

export type ExtraRatingTypesEnum = 'HeartRating' | 'StarRating'
export const ExtraRatingTypesEnumArray = ['HeartRating', 'StarRating']
...
export const LocalizableTypesEnumArray = ['Composition', 'CompositionAsset']

export type Species = 'cat' | 'dog' | 'frog'
export const SpeciesArray = ['cat', 'dog', 'frog']
